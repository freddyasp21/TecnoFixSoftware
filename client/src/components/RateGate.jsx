  ...
  return (
    <div className="mb-6 rounded-2xl border-2 border-rose-400 bg-rose-100 p-5">
      ...
      <p className="mt-1 text-sm text-rose-900">
        Es necesario registrar BCV, Euro y USDT para {action}. Sin la tasa de hoy no se puede abrir caja ni cotizar. La orden se crea al cobrar. Solo el administrador puede actualizar la tasa.
      </p>
