...
export default function OpsBanner() {
  ...
  return (
    <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
      {manage
        ? <>Fije la fecha de inicio de operaciones en el <Link className="font-semibold underline" to="/calendario">calendario</Link> para que el software cuente órdenes, caja y días laborados.</>
